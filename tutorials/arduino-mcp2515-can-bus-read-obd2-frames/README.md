# Arduino MCP2515 CAN Bus: Read raw OBD-II frames

This tutorial shows how to build a low-cost Arduino-based CAN bus reader using an MCP2515 module to capture raw OBD-II frames from a vehicle. The code in this folder contains the Arduino sketch that initializes the MCP2515, listens for CAN messages, and prints raw frame IDs, lengths, and data bytes to the Serial console.

**Read the full tutorial:** [Arduino MCP2515 CAN Bus: Read raw OBD-II frames](https://shillehtek.com/blogs/news/arduino-mcp2515-can-bus-read-obd2-frames)  
...
![Arduino MCP2515 CAN Bus: Read raw OBD-II frames](https://shillehtek.com/cdn/shop/articles/blog-thumbnail-626306154783.png?v=1778702641)
...
---
_Generated from [https://shillehtek.com/blogs/news/arduino-mcp2515-can-bus-read-obd2-frames](https://shillehtek.com/blogs/news/arduino-mcp2515-can-bus-read-obd2-frames). Last verified: see commit history._
