# Connects the Raspberry Pi Pico W to Wi‑Fi, initializes the Blynk client, reads the BME280 sensor over I2C, and prints the temperature to the console in a loop.
#
# Full tutorial: https://shillehtek.com/blogs/news/raspberry-pi-pico-w-bme280-send-data-to-blynk
