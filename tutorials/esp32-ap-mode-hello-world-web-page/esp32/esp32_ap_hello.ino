// Sets the ESP32 into Wi‑Fi Access Point mode and runs a simple HTTP server that accepts client connections and serves a web page.
//
// Full tutorial: https://shillehtek.com/blogs/news/esp32-ap-mode-hello-world-web-page
