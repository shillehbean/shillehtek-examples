// Arduino sketch that configures the ADXL345 over I2C, reads X/Y/Z acceleration values, and provides a calibration routine to compute axis offsets.
//
// Full tutorial: https://shillehtek.com/blogs/news/arduino-adxl345-calibrate-read-3-axis-data
