# Provides Wi‑Fi connection helper and an MQTT client using umqtt.simple to connect to an SSL MQTT broker.
#
# Full tutorial: https://shillehtek.com/blogs/news/raspberry-pi-pico-w-mqtt-send-messages-anywhere
