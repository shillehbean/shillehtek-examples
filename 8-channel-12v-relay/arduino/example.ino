// Initializes Arduino digital pins 7–14 as outputs (active LOW) and sequentially pulses each relay on and off with 500 ms delays.
//
...
// 8-Channel 12V Relay Module - Arduino Example
