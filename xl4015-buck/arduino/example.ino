// Reads the XL4015 output via a 30k/10k voltage divider into Arduino A0, converts the ADC reading to the rail voltage, and prints it to Serial every 0.5 seconds.
//
