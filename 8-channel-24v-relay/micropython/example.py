# MicroPython example for a Pico that sequentially drives eight relays on GP2–GP9 using active-LOW logic.
#
...
# 8-Channel 24V Relay Module - Pico MicroPython Example
