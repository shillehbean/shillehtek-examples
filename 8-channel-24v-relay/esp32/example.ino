// ESP32 Arduino-style example that toggles the 8 relays connected to GPIOs 5, 18, 19, 21, 22, 23, 25, and 26 in sequence (active LOW).
//
...
// 8-Channel 24V Relay Module - ESP32 Arduino Example
