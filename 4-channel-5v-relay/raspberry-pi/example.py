# Runs on a Raspberry Pi using RPi.GPIO to sequentially toggle relays (active LOW) wired to BCM pins 17, 27, 22, and 23, and cleans up GPIO on exit.
#
...
#!/usr/bin/env python3
# 4-Channel 5V Relay Module - Raspberry Pi Example
