// Demonstrates basic Arduino control of the four relay channels (active LOW) by cycling relays connected to digital pins 7–10 on and off with 500 ms intervals.
//
...
// 4-Channel 5V Relay Module - Arduino Example
